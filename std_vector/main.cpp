...
{
    Timer t;
    std::string watch_name = "Pilnas laikas";
    t.initialize_watch(0, watch_name);
    watch_name = "Skaitymas";
    t.initialize_watch(2, watch_name);
    watch_name = "Skaiciavimas";
    t.initialize_watch(3, watch_name);
    watch_name = "Rusiavimas";
    t.initialize_watch(4, watch_name);
